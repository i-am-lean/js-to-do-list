export class Todo {
    ...
    static #block = null //посилання на елемент (.main)
    static #template = null //посилання на елемент (.template)
    static #input = null //посилання на елемент (.input)
    static #button = null //посилання на елемент (.button)

    static init = () => {
        //логіка пошуку та привʼязки елемента в сторінці
    ...
    static #handleAdd = () => {
        ...
        //     this.#createTaskData(value)
          ...
          this.#input.value = '' //щоб після додавання інформації поле автоматично очищувалось  
        // }   
        this.#render() //оновлює список задач
        this.#saveData()
    ...
    static #render = () => {
        ...
        if (this.#list.length === 0) {
            this.#block.innerText = 'Cписок задач пустий'
        } else {
